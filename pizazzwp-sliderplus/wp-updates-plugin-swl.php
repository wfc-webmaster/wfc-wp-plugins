<?php
/*
WPUpdates Plugin Updater Class for Sellwire
http://wp-updates.com
v2.0

Example Usage:
require_once('wp-updates-plugin.php');
new WPUpdatesPluginUpdater_465( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

  // TODO: Add the code to manage the licencing

if( !class_exists('WPUpdatesPluginUpdater_465') ) {
    class WPUpdatesPluginUpdater_465 {
  ...
  new WPUpdatesPluginUpdater_465( 'http://wp-updates.com/api/2/plugin', 'pizazzwp-sliderplus/sliderplus.php');
