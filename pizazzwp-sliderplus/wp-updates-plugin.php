...
new WPUpdatesPluginUpdater_252( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_252') ) {
    class WPUpdatesPluginUpdater_252 {
  ...
  new WPUpdatesPluginUpdater_252( 'http://wp-updates.com/api/2/plugin', 'pizazzwp-sliderplus/sliderplus.php');
