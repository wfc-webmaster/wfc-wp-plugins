 ...
 * Modded: Chris Howard changed name from cycle to cycle2
 * replaced all fn.cycle with fn.cycle2 and .cycle( with .cycle2(
 */
(function(a) {
	function c(a) {
	...
	"use strict";
	var b = "20130205";
	a.fn.cycle2 = function(b) {
		var d;
		return this.length === 0 && !a.isReady ? (d = {s: this.selector, c: this.context}, a.fn.cycle2.log("requeuing slideshow (dom not ready)"), a(function() {
			a(d.s, d.c).cycle2(b)
		}), this) : this.each(function() {
			var d, e, f, g, h = a(this), i = a.fn.cycle2.log;
			if (h.data("cycle.opts"))
				return;
			if (h.data("cycle-log") === !1 || b && b.log === !1 || e && e.log === !1)
				i = a.noop;
			i("--c2 init--"), d = h.data();
			for (var j in d)
				d.hasOwnProperty(j) && /^cycle[A-Z]+/.test(j) && (g = d[j], f = j.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, c), i(f + ":", g, "(" + typeof g + ")"), d[f] = g);
			e = a.extend({}, a.fn.cycle2.defaults, d, b || {}), e.timeoutId = 0, e.paused = e.paused || !1, e.container = h, e._maxZ = e.maxZ, e.API = a.extend({_container: h}, a.fn.cycle2.API), e.API.log = i, e.API.trigger = function(a, b) {
				return e.container.trigger(a, b), e.API
			}, h.data("cycle.opts", e), h.data("cycle.API", e.API), e.API.trigger("cycle-bootstrap", [e, e.API]), e.API.addInitialSlides(), e.API.preInitSlideshow(), e.slides.length && e.API.initSlideshow()
		})
	}, a.fn.cycle2.API = {opts: function() {
			...
			var d = b, e;
			return c && d.manualFx && (e = a.fn.cycle2.transitions[d.manualFx]), e || (e = a.fn.cycle2.transitions[d.fx]), e || (e = a.fn.cycle2.transitions.fade, d.API.log('Transition "' + d.fx + '" not found.  Using fade.')), e
			...
			e = c.slides[c.currSlide], f = c.slides[c.nextSlide], g = c.API.getSlideOpts(c.nextSlide), h = c.API.calcTx(g, a), c._tx = h, a && g.manualSpeed !== undefined && (g.speed = g.manualSpeed), c.nextSlide != c.currSlide && (a || !c.paused && !c.hoverPaused && c.timeout) ? (c.API.trigger("cycle-before", [g, e, f, b]), h.before && h.before(g, e, f, b), d = function() {
				c.busy = !1;
				if (!c.container.data("cycle.opts"))
					return;
			...
			for (var h in g)
				g.hasOwnProperty(h) && /^cycle[A-Z]+/.test(h) && (e = g[h], f = h.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, c), d.API.log("[" + (d.slideCount - 1) + "]", f + ":", e, "(" + typeof e + ")"), g[f] = e);
			g = a.extend({}, a.fn.cycle2.defaults, d, g), g.slideNum = d.slideCount;
			try {
		...
		return"Cycle2: " + b
	}, a.fn.cycle2.transitions = {custom: {}, none: {before: function(a, b, c, d) {
			...
			}}}, a.fn.cycle2.defaults = {allowWrap: !0, autoSelector: ".cycle-slideshow[data-cycle-auto-init!=false]", delay: 0, easing: null, fx: "fade", hideNonActive: !0, loop: 0, manualFx: undefined, manualSpeed: undefined, manualTrump: !0, maxZ: 100, pauseOnHover: !1, reverse: !1, slideActiveClass: "cycle-slide-active", slideClass: "cycle-slide", slideCss: {position: "absolute", top: 0, left: 0}, slides: "> img", speed: 500, startingSlide: 0, sync: !0, timeout: 4e3, updateView: -1}, a(document).ready(function() {
		a(a.fn.cycle2.defaults.autoSelector).cycle2()
	})
})(jQuery), function(a) {
	"use strict", a.extend(a.fn.cycle2.defaults, {autoHeight: 0}), a(document).on("cycle-initialized", function(b, c) {
		function h() {
	...
	"use strict", a.extend(a.fn.cycle2.defaults, {caption: "> .cycle-caption", captionTemplate: "{{slideNum}} / {{slideCount}}", overlay: "> .cycle-overlay", overlayTemplate: "<div>{{title}}</div><div>{{desc}}</div>"}), a(document).on("cycle-update-view", function(b, c, d, e) {
		var f;
	...
	a.fn.cycle2 = function(c) {
		...
		return a.type(c) == "number" ? this.cycle2("goto", c) : a.type(c) == "string" ? this.each(function() {
			var h;
			...
			if (a.isFunction(e))
				return h = a.makeArray(g), h.shift(), e.apply(f.API, h);
			b.log("unknown command: ", d)
		}) : b.apply(this, arguments)
	}, a.extend(a.fn.cycle2, b), a.extend(b.API, {next: function() {
			var a = this.opts();
			...
			if (a.busy && !a.manualTrump)
				return;
			var b = a.reverse ? 1 : -1;
			if (a.allowWrap === !1 && a.currSlide + b < 0)
				return;
			...
			for (var h = 0; h < c.slides.length; h++)
				d = c.slides[h], h == b ? e = d : (f.push(d), a(d).data("cycle.opts").slideNum = g, g++);
	...
	function b(b, c) {
		...
		d = window.location.hash.substring(1), b.slides.each(function(e) {
			if (a(this).data("cycle-hash") == d)
				return c === !0 ? b.startingSlide = e : (b.nextSlide = e, b.API.prepareTx(!0, !1)), !1
		})
	}
	...
	"use strict", a.extend(a.fn.cycle2.defaults, {loader: !1}), a(document).on("cycle-bootstrap", function(b, c) {
		function e(b, e) {
			function h(b) {
				var h;
	...
	"use strict", a.extend(a.fn.cycle2.defaults, {pager: "> .cycle-pager", pagerActiveClass: "cycle-pager-active", pagerEvent: "click.cycle", pagerTemplate: "<span>&bull;</span>"}), a(document).on("cycle-bootstrap", function(a, c, d) {
		d.buildPagerLink = b
	...
	"use strict", a.extend(a.fn.cycle2.defaults, {next: "> .cycle-next", nextEvent: "click.cycle", disabledClass: "disabled", prev: "> .cycle-prev", prevEvent: "click.cycle", swipe: !1}), a(document).on("cycle-initialized", function(a, b) {
	...
	"use strict", a.extend(a.fn.cycle2.defaults, {progressive: !1}), a(document).on("cycle-pre-initialize", function(b, c) {
		if (!c.progressive)
			return;
	...
	"use strict", a.extend(a.fn.cycle2.defaults, {tmplRegex: "{{((.)?.*?)}}"}), a.extend(a.fn.cycle2.API, {tmpl: function(b, c) {
			var d = new RegExp(c.tmplRegex || a.fn.cycle2.defaults.tmplRegex, "g"), e = a.makeArray(arguments);
